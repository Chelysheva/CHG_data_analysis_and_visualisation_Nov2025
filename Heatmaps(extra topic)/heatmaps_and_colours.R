...
filenames = list.files(path = "Heatmaps(extra topic)/data", pattern = "counts.txt", full.names = TRUE)
filenames
...
# load results table
results = read.csv("Heatmaps(extra topic)/data/differentially_expressed_mirs_significant.csv", stringsAsFactors = FALSE)
# COLOURS ####
